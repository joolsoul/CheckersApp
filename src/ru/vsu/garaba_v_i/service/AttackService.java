...
public class AttackService {
    ...
    public boolean canIAttack(Checker oppositeChecker, Direction direction, Game game) {
        ...
        return cellWithOppositeChecker.hasNeighbor(direction) && cellWithOppositeChecker.hasNeighbor(direction) && !fieldService.isContainChecker(cellWithOppositeChecker.getNeighbor(direction), game);
    }
